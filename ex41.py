...
def heaven():
	print "You have crossed all the hurdles and deserve your success. Congratulations!"
	exit(1)
...
def princess_lives_here():
	...
	if eat_it == "eat it":
		...
		print "She gives you the very last bit of cake and shows you in."
...
def gold_koi_pond():
	...
	if feed_it == "feed it":
		...
		print "You fall in and the Koi shrugs you then eats you."
...
def big_iron_gate():
	...
	elif open_it == 'let the bear out and get in':
		print "You are now in a free world!"
