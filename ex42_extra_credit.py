...
class Map:
	...
	def bear_with_sword(self):	
		print "Fuzzled, you are about to pick up the fish poop diamond when"
		...
		if give_it == "give it":
			...
			print "It tries to put you hand back on, but you collapse."
	...
	def big_iron_gate(self):
		print "You walk up the big iron gate and see there's a handle."
		open_it = raw_input("> ")
		...
		elif open_it == "let the bear out":
			print "You have now been granted entry into heaven."
			return 'heaven'	
	...
	def heaven(self):
		print "You have crossed all the hurdles and reached heaven. You should be proud of your achievement!"
		exit(1)		
